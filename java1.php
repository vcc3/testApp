...
//define page title
$title = 'Java Tutorial For Beginners 1 - Introduction and Installing the java';
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Java
                    <small>Java Tutorial For Beginners 1</small>
                </h1>
            </div>
        </div>
        <!-- /.row -->
            ...
            <div class="col-md-9 portfolio-item">
                ...
                <div class="caption">
                  ...
                  <form method = "post" action = "<?php $_PHP_SELF ?>">
                    <input type="hidden" name="url" id ="url" value="java1.php">
                    <input type="hidden" name="videoname" id ="videoname" value=" Java Tutorial For Beginners 1">
