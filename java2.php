...
//define page title
$title = 'Java Tutorial For Beginners 2 - Installing Eclipse IDE and Setting up Eclipse';
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Java
                    <small>Java Tutorial For Beginners 2</small>
                </h1>
            </div>
        </div>
        <!-- /.row -->
            ...
            <div class="col-md-9 portfolio-item">
                ...
                <div class="caption">
                  ...
                  <form method = "post" action = "<?php $_PHP_SELF ?>">
                    <input type="hidden" name="url" id ="url" value="java2.php">
                    <input type="hidden" name="videoname" id ="videoname" value=" Java Tutorial For Beginners 2">
